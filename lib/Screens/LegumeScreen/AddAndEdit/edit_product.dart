                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      if (_formKey.currentState!.validate()) {
                        sqflite.insertData(
                            "UPDATE 'legume' SET ('amount','date') = ('${amountController.text}','${dateController.text}') WHERE id = ${widget.id}");
                        // Navigator.of(context).pop();
                        Navigator.of(context).pushAndRemoveUntil(
                            MaterialPageRoute(
                                builder: (context) => LegumeScreen()),
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      if (_formKey.currentState!.validate()) {
                        sqflite.deletData(
                            "DELETE FROM 'legume' WHERE id = ${widget.id}");
                        // widget.refreshFun();
                        // Navigator.of(context).pop();
                        Navigator.of(context).pushAndRemoveUntil(
                            MaterialPageRoute(
